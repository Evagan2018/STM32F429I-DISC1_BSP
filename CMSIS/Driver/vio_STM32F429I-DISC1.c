/******************************************************************************
 * @file     vio_STM32F429I-DISC1.c
 * @brief    Virtual I/O implementation for board STM32F429I-DISC1
 * @version  V1.0.0
 * @date     9. October 2024
 ******************************************************************************/
/*
...
/*! \page vio_STM32F429I-DISC1 Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red     (LD4)    | PG14
| vioLED1       | vioSignalOut.1 | LED green   (LD3)    | PG13
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTG(14), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTG(13), ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
